            ...
            <div class='activity'>    
                <?php foreach ($dishes as $index => $dish) : ?>
                    <div class='form-items'>
                        <div>
                            <?php
                                echo "<label class='text-details' for='am" . $index . "'>";
                                echo $dish["nombre"];
                                echo "<span>($" . $dish["precio"] . ")</span>";
                                echo "</label>";
                            ?>
                        </div>
                        <div>
                            <?php
                                echo "<input id='am" . $index . "' data-index='" . $index . "' data-price='" . $dish["precio"] . "' class='form-input' type='number' name='extras[" . $dish["id_informacion_platillo"] . "]' step='1' value='0' min='0' max='1000' oninput='updateTotal()'>";
                            ?>
                        </div>
                        <div>
                            <?php
                                echo "<p class='text-details' id='dish" . $index . "'>$0</p>";
                            ?>
                        </div>
                    </div>
                <?php endforeach; ?>
